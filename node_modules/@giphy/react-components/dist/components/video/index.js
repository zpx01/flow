...
var Video = function (_a) {
    ...
    // state
    var _d = react_1.useState(js_util_1.getBestVideo(gif.video, width, height)), media = _d[0], setMedia = _d[1];
    ...
    var previousPlayhead = react_1.useRef(0);
    ...
    }, [width, height_, gif.video, height, media === null || media === void 0 ? void 0 : media.url]);
    react_1.useEffect(function () {
    ...
    var _onTimeUpdate = react_1.useCallback(function () {
        ...
        if (el) {
            ...
            if (Math.floor(playhead_1) === 0 && Math.floor(previousPlayhead.current) > 0) {
            ...
            previousPlayhead.current = playhead_1;
            onTimeUpdate === null || onTimeUpdate === void 0 ? void 0 : onTimeUpdate(el.currentTime || 0);
        }
    ...
    var _onEnded = react_1.useCallback(function () { return onEnded === null || onEnded === void 0 ? void 0 : onEnded(); }, [onEnded]);
    ...
    return (media === null || media === void 0 ? void 0 : media.url) ? (react_1.default.createElement("video", { className: className, width: width, height: height, loop: loop, muted: muted, autoPlay: true, playsInline: true, ref: videoEl, src: media === null || media === void 0 ? void 0 : media.url })) : null;
};
